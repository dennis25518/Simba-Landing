...
const LandingPage: React.FC<{ onNavigate: (path: string) => void }> = ({
  onNavigate,
}) => {
  return (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-8">
              ...
              <div className="grid grid-cols-3 gap-4">
                ...
                <div>
                  <div className="text-3xl font-black text-red-600">60min</div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-20">
            ...
            <p className="text-lg  text-black-700 max-w-3xl mx-auto leading-relaxed font-heavy">
              Whether you're buying, selling, or delivering, Simba Exprss has
              you covered. We provide seamless, integrated commerce experiences
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="group relative bg-white rounded-2xl overflow-hidden border border-gray-100 hover:border-orange-500 hover:shadow-2xl transition-all duration-300">
              ...
              <div className="p-8 relative z-10">
                ...
                <p className="text-gray-600 text-sm leading-relaxed mb-6">
                  Earn flexibly on your schedule. Smart order routing, real-time
                  earnings tracking, and instant payouts for your deliveries.
                </p>
                <ul className="space-y-3 mb-8">
                  <li className="flex items-start gap-3">
                ...
                <button
                  onClick={() =>
                    (window.location.href = "https://driver.simbaxp.vercel.app")
                  }
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              },
              {
                number: "50K+",
                label: "Jobs Created",
                description: "Drivers, merchants, and support staff employed",
              },
              {
                number: "1M+",
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 max-w-3xl mx-auto">
              ...
              <button
                onClick={() =>
                  (window.location.href = "https://merchant.simbaxp.vercel.app")
                }
