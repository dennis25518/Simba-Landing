                  ...
                  <div className="space-y-8">
                    <div>
                      ...
                      <p className="text-xl text-gray-600 leading-relaxed">
                        Simba Express is a lightning-fast, commerce-first
                        platform transforming how businesses and customers
                        connect across Africa. One platform. Infinite
                        possibilities.
                      </p>
                    </div>
                  ...
                  <div className="group relative bg-white rounded-2xl overflow-hidden border border-gray-100 hover:border-blue-500 hover:shadow-2xl transition-all duration-300">
                    ...
                    <div className="p-8 relative z-10">
                      ...
                      <p className="text-gray-600 text-sm leading-relaxed mb-6">
                        Browse thousands of products from trusted merchants.
                        Fast, secure checkout with real-time order tracking and
                  ...
                  <div className="group relative bg-white rounded-2xl overflow-hidden border border-gray-100 hover:border-orange-500 hover:shadow-2xl transition-all duration-300">
                    ...
                    <div className="p-8 relative z-10">
                      ...
                      <p className="text-gray-600 text-sm leading-relaxed mb-6">
                        ...
                        real-time earnings tracking, and instant payouts for
                        your deliveries.
                      </p>
                      <ul className="space-y-3 mb-8">
                        <li className="flex items-start gap-3">
            ...
            <section id="features" className="py-28 bg-gray-50">
              <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="text-center mb-20">
                  ...
                  <p className="text-lg text-black-700 max-w-3xl mx-auto leading-relaxed font-heavy">
                    Engineered for Africa's unique market needs. Designed to
                    scale across the continent. Optimized for speed and
                    reliability.
                  </p>
                </div>
